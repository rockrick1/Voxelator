...
namespace WorldGeneration
{
    ...
    {
        const int PERMUTATION_COUNT = 255;
        const int DIRECTION_COUNT = 15;
        
        static readonly int[] _permutation =
        {
        ...
        static float Scalar(Vector3 a, Vector3 b)
        {
        ...
        public static float Get3DPerlinNoise(Vector3 point, float frequency)
        {
            ...
            flooredPointX0 &= PERMUTATION_COUNT;
            flooredPointY0 &= PERMUTATION_COUNT;
            flooredPointZ0 &= PERMUTATION_COUNT;
        ...
        */
            Vector3 direction000 = _directions[_permutation[permutationY00 + flooredPointZ0] & DIRECTION_COUNT];
            Vector3 direction100 = _directions[_permutation[permutationY10 + flooredPointZ0] & DIRECTION_COUNT];
            Vector3 direction010 = _directions[_permutation[permutationY01 + flooredPointZ0] & DIRECTION_COUNT];
            Vector3 direction110 = _directions[_permutation[permutationY11 + flooredPointZ0] & DIRECTION_COUNT];
            Vector3 direction001 = _directions[_permutation[permutationY00 + flooredPointZ1] & DIRECTION_COUNT];
            Vector3 direction101 = _directions[_permutation[permutationY10 + flooredPointZ1] & DIRECTION_COUNT];
            Vector3 direction011 = _directions[_permutation[permutationY01 + flooredPointZ1] & DIRECTION_COUNT];
            Vector3 direction111 = _directions[_permutation[permutationY11 + flooredPointZ1] & DIRECTION_COUNT];
        ...
        */
            ...
            return Mathf.Lerp(
                Mathf.Lerp(Mathf.Lerp(value000, value100, smoothDistanceX),
                    Mathf.Lerp(value010, value110, smoothDistanceX), smoothDistanceY),
                Mathf.Lerp(Mathf.Lerp(value001, value101, smoothDistanceX),
                    Mathf.Lerp(value011, value111, smoothDistanceX), smoothDistanceY),
                smoothDistanceZ);
        }
    }
